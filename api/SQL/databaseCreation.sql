...
('BT4877', 7600,'SweatShirt', 'JACK & JONES', 'Homme'),
('65352U-HUJ', 3500,'FW LARGE LOGO COTTON TEE', 'UMBRO', 'Femme'),
('FW0FW05786-GU9', 218000,'TH Essentials Leather Loafer', 'TOMMY HILFIGER', 'Homme'),
('36515-0112', 9200,'511 Slim Hemmed Short', 'LEVIS', 'Femme');
...
VALUES ('12152840-RED', 1, 'Tighiouart', 'Moncef', 'moncef@gmail.com', '51 Cheraga', 06060600606),
 ('FY9214', 2, 'Tighiouart', 'Moncef', 'moncef@gmail.com', '51 Cheraga', 06060600606),
 ('ERJZT04514-WBT0', 1, 'Mohamed', 'Riad', 'M.r@gmail.com', 'Kouba', 0567598854);